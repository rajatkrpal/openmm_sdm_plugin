...
extern "C" __global__ void sdmForce(int numAtoms, int paddedNumAtoms, const real4* __restrict__ posq,unsigned long long* __restrict__ force, int atom1, int atom2, real kf, real r0, real lambdaId) {
